...
void setup() {
  ...
  meuArquivo.print("sensor_reading V DP(kPa) veloc(m/s) Accelx Accely Accelz Gyrox Gyroy Gyroz Magx Magy Magz Temperatura(C)");
  meuArquivo.close();
...
void loop() {
  ...
  meuArquivo.print(" ");
  meuArquivo.print(volts, 4);
  meuArquivo.print(" ");
  meuArquivo.print(DP, 4);
  meuArquivo.print(" ");
  meuArquivo.print(veloc, 2);
  meuArquivo.print(" ");
